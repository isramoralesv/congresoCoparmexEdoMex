                ...
                <div class="content-frame">
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-male"></span> USUARIOS</h2>
                        </div>                                      
                            ...
                            <div class="panel panel-default" >
                                <div class="panel-heading" style="background-color: #ffffff;">
                                    <div class="panel-title-box" style="height: 100px;">
                                        <button class="btn btn-default" ><a href="notificaciones.php" style="text-decoration: none;">Ir a Notificaciones</a></button>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Exportar Datos</button>
